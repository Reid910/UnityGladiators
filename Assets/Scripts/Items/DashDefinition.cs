...
public class DashDefinition : ScriptableObject
{
    ...
    [Tooltip("How long after dashing the player takes zero damage/effects at all — a real i-frame window, not just hyper armor. A correctly-timed dash dodges even a would-be finisher.")]
